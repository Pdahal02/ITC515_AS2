...
public class XMLManager {// creates a class called XMLManageer
	private static XMLManager self = null;// assigns null to the class

	private Document doc;// creates a private document called doc

	public static XMLManager getXML() {// gets XML if not null
		if (self == null)
			self = new XMLManager();
		return self;
	}
