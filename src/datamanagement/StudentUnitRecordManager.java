...
public class StudentUnitRecordManager {// creates the class

	private static StudentUnitRecordManager s = null;// assigns null to class
	private StudentUnitRecordMap rm;// assigns rm to class
	private java.util.HashMap<String, StudentUnitRecordList> ur;
	private java.util.HashMap<Integer, StudentUnitRecordList> sr;

	public static StudentUnitRecordManager instance() {// ammend the class is class is not null
		if (s == null)
