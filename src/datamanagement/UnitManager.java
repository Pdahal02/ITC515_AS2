...
public class UnitManager {// class unit manager is created

	private static UnitManager self = null;// assigns null to the class

	private UnitMap UM;// creates unitmap and assigns it to UM
