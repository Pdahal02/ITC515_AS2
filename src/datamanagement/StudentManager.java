...
public class StudentManager {// program creates a class student manager
	private static StudentManager self = null;// assigns null to the class

	private StudentMap sm;// sm assigned to student map
	private java.util.HashMap<String, StudentMap> um;

	public static StudentManager get() {// gets the student manager if not null
		if (self == null)
